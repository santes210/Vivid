...
val VividTypography = Typography(
    ...
    // ---------------------------------------------------------------
    //  Variantes Emphasized (Material 3 Expressive)
    //  Títulos "más fuertes" para momentos hero y jerarquía editorial.
    //  Solo cambia peso + tracking; heredan la fuente/color del base.
    //  Requiere material3 1.5.0-alpha (opt-in Expressive ya activado).
    // ---------------------------------------------------------------
