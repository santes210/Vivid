    ...
    val Create: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                moveTo(7f, 3.75f)
                lineTo(17f, 3.75f)
                curveTo(18.79f, 3.75f, 20.25f, 5.21f, 20.25f, 7f)
                lineTo(20.25f, 17f)
                curveTo(20.25f, 18.79f, 18.79f, 20.25f, 17f, 20.25f)
                lineTo(7f, 20.25f)
                curveTo(5.21f, 20.25f, 3.75f, 18.79f, 3.75f, 17f)
                lineTo(3.75f, 7f)
                curveTo(3.75f, 5.21f, 5.21f, 3.75f, 7f, 3.75f)
                close()
                moveTo(12f, 7.75f)
                lineTo(12f, 16.25f)
                moveTo(7.75f, 12f)
